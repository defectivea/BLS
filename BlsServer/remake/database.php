<?php
	...
	*/
	...
	//	$insert = "INSERT INTO gps ('bus_id', 'latitude', 'longitude', 'time') VALUES($bus_id, $latitude, $longitude, $now)";
		...
		$insert = "INSERT INTO `bls`.`gps` (`bus_id`, `latitude`, `longitude`, `time`) VALUES ('$bus_id', '$latitude', '$longitude', '$now');
";
		return $insert;
	}

	function make_insert_signup($email, $password) {
			$insert = "INSERT INTO `bls`.`user` (`mail`, `password`) VALUES ('$email', '$password');
			return $insert;
	}
