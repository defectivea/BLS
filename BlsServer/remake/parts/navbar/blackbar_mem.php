	...
	<div class="navbar-collapse collapse">
		...
		<?php
				...
				if ($_SERVER['REQUEST_URI'] == "/BlsServer/remake/SignUp.php") {
					echo '<li class="active"><a href="SignUp.php">詳細設定</a></li>';
				}
				else {
					echo '<li><a href="SignUp.php">詳細設定</a></li>';
				}

				if ($_SERVER['REQUEST_URI'] == "/BlsServer/remake/SignIn.php") {
					echo '<li class="active"><a href="SignIn.php">サインアウト</a></li>';
				}
				else {
					echo '<li><a href="SignIn.php">サインアウト</a></li>';
				}
			?>
		</ul>
	</div>
